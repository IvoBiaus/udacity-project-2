...
var authenticate = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var credentials, user, token, e_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                credentials = {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.authenticate(credentials)];
            case 2:
                user = _a.sent();
                token = jsonwebtoken_1["default"].sign({ user: user }, "" + JWT_SECRET);
                res.json(token);
                return [3 /*break*/, 4];
            case 3:
                e_3 = _a.sent();
                res.status(401).send(e_3);
                return [3 /*break*/, 4];
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                newUser = _a.sent();
                tkn = jsonwebtoken_1["default"].sign({ user: newUser }, "" + JWT_SECRET);
                res.json(tkn);
                return [3 /*break*/, 4];
            case 3:
                e_4 = _a.sent();
